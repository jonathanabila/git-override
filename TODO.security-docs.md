# Security And Documentation TODOs

## Rules

- Only work on items listed in this file.
- If new work is needed, add it here before making that change.
- Complete security items before documentation refresh items.
- After each TODO:
  - update this file,
  - commit the changes for that TODO,
